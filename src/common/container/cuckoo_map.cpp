...
#include <include/storage/data_table.h>
...
template class CuckooMap<storage::CuckooMapKey , storage::TileGroup *, storage::CuckooHash, storage::CuckooComp>;

template class CuckooMap<oid_t, std::pair<type::Value,type::Value>>;
